...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-lg font-secondary text-sm transition duration-500 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 cursor-pointer flex items-center gap-4 active:scale-90";
