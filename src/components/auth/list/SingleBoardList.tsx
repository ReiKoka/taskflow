...
function SingleBoardList({ list, setItems, cards, onCardMove, setAllCards, onEditStateChange}: SingleBoardListProps) {
  ...
  return (
    <div
      className="bg-secondary font-secondary flex max-h-full shadow-custom-3 dark:shadow-none overflow-y-auto min-h-24 max-w-72  min-w-72 flex-col rounded-xl pl-3 py-3 pr-1.5"
      onDrop={handleDrop}
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <input 
          ...
          <Button variant="icon" className="group/delete-list border-0 hover:bg-destructive rounded-md mr-1">
